...
router.post('/refresh', validator_1.default(schema_1.default.auth, validator_1.ValidationSource.HEADER), validator_1.default(schema_1.default.refreshToken), asyncHandler_1.default(async (req, res) => {
